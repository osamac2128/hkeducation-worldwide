    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          {unigeniConfig.whatIsUnigeni.map((p, idx) => (
            <p
              key={idx}
              className="font-sans-body"
              style={{
      ...
      >
        ...
        >
          {unigeniConfig.features.map((feature, idx) => (
      ...
      >
        ...
        >
          {unigeniConfig.howItHelpsTitle}
        </h2>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {unigeniConfig.howItHelpsItems.map((item, idx) => (
            <div key={idx}>
              <div
                style={{
                  paddingTop: idx !== 0 ? 28 : 0,
                  paddingBottom: 28,
                  ...(idx !== 0 ? { borderTop: '1px solid rgba(255,255,255,0.08)' } : {}),
                }}
              >
                <h3
                  className="font-serif-display"
