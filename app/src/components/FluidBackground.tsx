...
void main() {
  ...
  uv += fluidVel * (0.028 + 0.12 * fluidInk);
  ...
  // More subdued, professional education palette
  vec3 color1 = vec3(0.02, 0.04, 0.07);
  vec3 color2 = vec3(0.04, 0.10, 0.18);
  vec3 color3 = vec3(0.10, 0.22, 0.35);

  vec3 finalColor = mix(mix(color1, color2, pattern), color3, pattern * pattern * 0.7);
